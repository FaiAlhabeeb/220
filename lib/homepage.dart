  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      bottomNavigationBar: GNav(
        ...
        selectedIndex: 0,
        tabs: [
        GButton(icon: Icons.ad_units_outlined , iconColor: Color.fromARGB(255, 135, 108, 139),onPressed: (){Navigator.push(context,MaterialPageRoute(builder: (context) => PostJobScreen())); }, ),
        ...
        GButton(icon: Icons.account_box , iconColor: Color.fromARGB(255, 135, 108, 139),onPressed:
            (){ Navigator.push(context,MaterialPageRoute(builder: (context) =>const componyProfile()));},),
      ...
      body:  JobList(jobs: [], companyId: "${credintial?.uid}")
