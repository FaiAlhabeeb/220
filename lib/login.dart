...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    Future<bool> checkinguserC() async {
      bool result = false;
      var collection = FirebaseFirestore.instance.collection('Compony');
      collection.snapshots().listen((querySnapshot) {
        for (var doc in querySnapshot.docs) {print(doc.id);
          if (doc.id == u){result = true;} 
    ...
    Future<bool> checkinguserA() async {
      bool result = false;
